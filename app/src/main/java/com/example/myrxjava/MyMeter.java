...
public class MyMeter extends View {
    ...
    private int dialSpeedColor = Color.DKGRAY;
    ...
    public MyMeter(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//            canvas.drawArc(progressBarRect, 0, alertSpeedAngle, false, mSpeedProgressPaint);
        ...
        canvas.drawText(unitOfMeasurement, x, y - ((mSpeedUnitPaint.descent() + mSpeedUnitPaint.ascent()) / 4), mSpeedUnitPaint);
...
//        }
    ...
    public void setMeterType(String unitOfMeasurement) {
